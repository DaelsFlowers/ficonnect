    ...
    <View style={styles.container}>
      ...
      {selectedUserId ? (
        <View style={styles.chatContainer}>
          ...
          onPress={() => navigation.navigate('VideoCall', { channelName: selectedUserId })} // Pasa el ID del usuario seleccionado como nombre del canal
          >
            <Text style={styles.videoCallButtonText}>{t('Video Call')}</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  videoCallButton: {
    backgroundColor: '#28A745', // Color verde para el botón de videollamada
    padding: 10,
    borderRadius: 5,
    alignItems: 'center',
    marginTop: 10,
